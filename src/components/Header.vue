<script setup>
    ...
    defineEmits(['decrementar-cantidad', 'incrementar-cantidad', 'agregar-carrito', 'eliminar-producto', 'eliminar-todo']);
                    ...
                    <div class="carrito">
                        ...
                        <div id="carrito" class="bg-white p-3">
                            ...
                            <div v-else>
                                ...
                                <button  @click="$emit('eliminar-todo')" class="btn btn-dark w-100 mt-3 p-2">Vaciar Carrito</button> 
                            </div>
                        </div>
                    </div>
                </nav>
